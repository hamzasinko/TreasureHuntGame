        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _helpItem(Symbols.sensors, 'Bring each shell to the correct RFID antenna on the poolside.'),
              _helpItem(Symbols.check_circle, 'Green light and a sound = correct antenna — point scored!'),
              _helpItem(Symbols.cancel, 'Red light and a buzzer = wrong antenna — try again.'),
